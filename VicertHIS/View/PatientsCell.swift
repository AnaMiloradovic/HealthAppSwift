...
class PatientsCell: UITableViewCell {
    ...
    func setupViews(){
        ...
        patientName.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 8).isActive = true
        patientName.centerXAnchor.constraint(equalTo: self.centerXAnchor, constant: 5).isActive = true
        patientName.widthAnchor.constraint(equalToConstant: 50).isActive = true
        ...
        adressImage.topAnchor.constraint(equalTo: patientName.bottomAnchor, constant: 5).isActive = true
